first_page_flat = 'https://www.avito.ru/moskva/kvartiry/prodam/1-komnatnye-ASgBAQICAUSSA8YQAUDKCBSAWQ?cd=1&map=e30%3D'
...
dict_headers = {
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.82 Safari/537.36',
...
#         'limit': 10
# }
request_url_start = 'https://www.avito.ru/js/v2/map/items?categoryId=24&locationId=637640&correctorMode=1&page='
request_url_end = '&map=e30%3D&params%5B201%5D=1059&params%5B549%5D%5B0%5D=5696&verticalCategoryId=1&rootCategoryId=4&viewPort%5Bwidth%5D=940&viewPort%5Bheight%5D=230&limit='
first_page = 1
first_page_url = request_url_start+str(first_page)+request_url_end+str(limit)
